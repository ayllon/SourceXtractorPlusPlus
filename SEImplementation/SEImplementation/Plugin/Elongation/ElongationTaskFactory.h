 ...
 */
#ifndef _SEIMPLEMENTATION_PLUGIN_ELOPNGATIONTASKFACTORY_H_
#define _SEIMPLEMENTATION_PLUGIN_ELOPNGATIONTASKFACTORY_H_
...
#endif /* _SEIMPLEMENTATION_PLUGIN_ELOPNGATIONTASKFACTORY_H_ */
